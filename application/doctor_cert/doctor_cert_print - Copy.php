...
<div class="content">
    <h2>ส่วนที่ ๑ ของผู้รับใบรับรองสุขภาพ</h2>
    <div>
        ข้าพเจ้า  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <?
        if($obj->pname  == ''){
...
&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<div>หมายเหตุ  (๑) ต้องเป็นแพทย์ซึ่งได้ขึ้นทะเบียนรับใบอนุญาตประกอบวิชาชีพเวชกรรม  (๒) ให้แสดงว่าเป็นผู้มีร่างกายสมบูรณ์เพียงใด<br/>
